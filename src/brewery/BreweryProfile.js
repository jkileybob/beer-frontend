...
const BreweryProfile = (props) => {
  ...
  const map=()=>{console.log("map stuff")}
    ...
    <>
      <Grid centered columns={2}>
        <Grid.Column>
          <Card centered >
            <Card.Content>
            <Header textAlign='center' size='huge' >{props.brewery.name}</Header>
            ...
            <Card.Content>
              <Card.Description textAlign="center" onClick={map} color="black" size='small' >
                <Icon link circular inverted color='teal' name='map' />
                Map
              </Card.Description>
            </Card.Content>
            <Card.Content>
        ...
        <Grid.Column>
          <Image centered size='small' src='https://bellinghamsbestbeer.files.wordpress.com/2008/10/bright_tank.jpg' />
          <Divider horizontal>Logged Beers</Divider>
            <List>
